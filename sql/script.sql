...
INSERT INTO `fees_master` (`id`,`fees_type`,`fees_name`,`fees_amt`,`status`) VALUES 
 ...
 (2,'TERM FEES','QUARTELY','250.14','ACTIVE'),
 (3,'TERM FEES','ANNUALY','250.14','ACTIVE'),
 (4,'EXAM FEES','1ST MITTERM','500','ACTIVE');
...
INSERT INTO `trans_master` (`id`,`type`,`sub_type`,`trans_desc`,`status`) VALUES 
 ...
 (3,'INCOME','MANAGEMENT A/C','Home bill','ACTIVE'),
...
INSERT INTO `transaction_details` (`transaction_id`,`transaction_code`,`trans_desc`,`amount`,`balance`,`create_user_id`,`create_date`,`change_user_id`,`change_date`,`trans_date`,`trans_type`,`trans_sub_type`,`payment_type`) VALUES 

...
import com.cubepro.subject.form.SubjectDetailForm;
import com.cubepro.subject.helper.SubjectDetailHelper;
import com.cubepro.subject.helper.SubjectHelper;

public class SubjectDetailAction extends TransactionAction{
	...
	public CubeProActionForward processRequest(ActionMapping mapping,
		...
		try {
			...
			subjectDetailForm.setClassList(classDetailHelper.findAll(session));
			subjectDetailForm.setSubjects(subjectHelper.findAll(session));

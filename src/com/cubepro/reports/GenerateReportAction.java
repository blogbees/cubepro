...
public class GenerateReportAction extends TransactionAction {
	...
	//<img src='"+contextPath+"/images/logo.png' class='logo' width='770' height='62' />
	private String buildHeader(String contextPath, String paramString){
		...
		"<link href='"+contextPath+"/css/print.css' rel='stylesheet' type='text/css'  media='print' /><div id='header'>  "+
		"<p align='right' class='noprint' >" + "<a href = '"+contextPath+"/ExportToPDF.cp?exportTo=pdf&"+paramString+"'>" +
		...
		+ "&nbsp" + "<a href='"+contextPath+"/ExportToExcel.cp?exportTo=excel&"+paramString+"'>" +
		 ...
		 "<img src='"+contextPath+"/images/pdf.gif' width='16px' height='16px'/></a></p></div>";
		return header;
	}
	
	private String buildFooter(String contextPath, String paramString, int currentPageNo, int totalNoOfPages){
		StringBuffer footer = new StringBuffer();
		footer.append("<table align='center' class='noprint'><tr><td align='center'>");
		footer.append("<div id='button' class='noprint' >");
		footer.append("<ul>");
		if(currentPageNo > 0){

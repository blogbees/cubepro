	...
	public String testAndQualifyPort() throws Exception {
		...
		while (portList.hasMoreElements()) {
			...
			if (portId.getPortType() == CommPortIdentifier.PORT_SERIAL) {
				...
				boolean comPortSuccess = false;
				try {
				//	if (portId.getName().equals(CubeProConstants.COM_1) == true
				//|| portId.getName().equals(CubeProConstants.COM_3) == true
				//	) {
						//comPortSuccess = sendMessage.doIt(portId.getName());
				//	}

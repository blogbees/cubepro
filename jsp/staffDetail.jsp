	...
	mmLoadMenus();	
	   ...
	   function SubmitOnEnter(e) {
			...
			function submitSearch(){
			 if(validate()){
					document.forms[0].action="<%=request.getContextPath()%>/ListOfStaffs.cp?action=getListOfStaffs";
		...
		<tr>
			<td class="padding">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td width="100%">
							<html:form action="ListOfStaffs" method="post">
															...
															<tr class="toggle-section1">
																<td>
																	<display:table id="staffListTableId" 
																		name="searchResult" 
																		requestURI="ListOfStaffs.cp?action=getListOfStaffs"

	...
	mmLoadMenus();	
	   function SubmitOnEnter(e) {
			...
			function submitSearch(){
				document.forms[0].action="<%=request.getContextPath()%>/EditLogin.cp";
				document.forms[0].submit();
			}
			
			function saveForm(){
				document.forms[0].action="<%=request.getContextPath()%>/EditLogin.cp?action=saveLogin";
				document.forms[0].submit();
			}
			
		
			function resetFilters(){
				document.forms[0]['loginDetails.userId'].value = 0;
				document.forms[0]['loginDetails.userName'].value = "";
				document.forms[0]['loginDetails.password'].value = "";
			}
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td colspan="3" class="bread-crumb"><a
					...
					key="nrega.home" /></a> &gt; <span>Login Master</span></td>
			</tr>
			...
			<tr>
				<td width="100%"><html:form action="EditLogin" method="post">
							...
							<table width="100%" border="0" cellspacing="1" cellpadding="0"
								...
								<tr>
									<td colspan="8" class="form-heading"><span
										class="search-heading">Login Master </span></td>
								</tr>
								<tr>
									...
									<table width="100%" border="0" cellspacing="1" cellpadding="0"
										...
										<tr>
											<td class="form-row-text" nowrap>Login Name :</td>
											<td class="form-row-input"><html:text
												property="loginDetails.userName" size="20" maxlength="45"
												styleId="searchProjectName"
												 /></td>
											<td class="form-row-text" nowrap>PassWord:</td>
											<td class="form-row-input"><html:password
												property="loginDetails.password" size="20" maxlength="45"
												styleId="searchProjectName"
												 /></td>
												</tr>
												<tr>
											...
											<td class="form-row-input"><html:select
												property="loginDetails.status" style="width:100px;">
												<html:option value="ACTIVE">ACTIVE</html:option>
												<html:option value="IN-ACTIVE">IN-ACTIVE</html:option>
											</html:select>
											<html:hidden property="loginDetails.userId" /> 
											</td>
								...
								<tr class="toggle-section0">
									<td><bean:define id="pageSizeList" name="loginForm"
										property="pageSizeList" toScope="page" /> <logic:empty
										property="loginDetailsList" name="loginForm">
										<bean:message key="no.search.projects" />
									</logic:empty> <logic:notEmpty property="loginDetailsList" name="loginForm">
										<tr>
											...
											<table width="100%" border="0" cellspacing="1"
												...
												<tr class="toggle-section1">
													<td colspan="8"><display:table id="loginDetailsId"
														name="searchResult" requestURI="EditLogin.cp" pagesize="10"
														...
														<display:column title=""
															href="EditLogin.cp?action=getLogin&" paramId="id"
															paramProperty="userId" value="Edit" style="width: 13%"

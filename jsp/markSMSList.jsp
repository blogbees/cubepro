	...
	mmLoadMenus();	
	   function SubmitOnEnter(e) {
			...
			function submitSearch(){
				document.forms[0].action="<%=request.getContextPath()%>/MarkSMS.cp?action=getListOfMarks";
				document.forms[0].submit();
			}
			
			function submitAttendanceForm(){
				document.forms[0].action="<%=request.getContextPath()%>/MarkSMS.cp?action=smsStudentMarks";
				document.forms[0].submit();
			}
			
			function getExams(){
				document.forms[0].action="<%=request.getContextPath()%>/MarkSMS.cp?action=getTerms";
				document.forms[0].submit();
			}
		...
		<tr>
			<td class="padding">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td width="100%">
							<html:form action="MarkSMS" method="post">
								<table width="100%" border="0" align="center" cellpadding="0"
											...
											<table width="100%" border="0" cellspacing="1"
												...
												<tr>
													...
													<html:select property="searchStudentDetails.pta"
															styleId="searchProjectName" style="width:79px;" value="">
													...
													<td class="form-row-input">
														<html:select
															...
															styleId="searchProjectName" onchange="javascript:getExams();" style="width:100px;">
									...
									<tr class="toggle-section0">
										<td>
											<bean:define id="pageSizeList" name="markSMSForm"
												property="pageSizeList" toScope="page" />
											<logic:empty property="markDetails" name="markSMSForm">
												...
												<tr>
													<td class="padding-btm-ten">
														<table width="100%" border="0" cellspacing="1"
																...
																<td>
																	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="padding-btm-ten form-border display-table-header">
																		<tr>
																			...
																			<logic:iterate id="subjectDetail" name="markSMSForm" property="subjectList" indexId="i" >
																				<th class="grid-heading-row"><bean:write name="subjectDetail" property="subjectName"/></th>	
																			</logic:iterate>
																																						
																		</tr>
																		<logic:iterate id="subjectWiseMark" name="markSMSForm" property="markDetails" type="java.util.ArrayList" indexId="i" >
																			<tr>
																			<logic:iterate id="markDetail" name="subjectWiseMark" indexId="j" >
																				...
																				<td class="grid-row">
																					...
																					<html:hidden name="markDetail" property="markObtained" indexed="true"/>
																					<bean:write name="markDetail" property="markObtained" />
																				</td>
															...
															<tr><td class="grid-row" colspan="2" >SMS&nbsp;<html:textarea property="smsToBeSent" cols="5" rows="5" value="SMS" ></html:textarea></td></tr>
															<tr>
										<td align="right">
											<table>
												<tr>

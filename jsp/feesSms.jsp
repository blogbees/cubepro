	...
	mmLoadMenus();	
	   function SubmitOnEnter(e) {
			...
			function submitSearch(){
			   ToDate();
				document.forms[0].action="<%=request.getContextPath()%>/FeesSMS.cp?action=getListOfStudents";
				document.forms[0].submit();
				//}
			}
			
			function submitAttendanceForm(){
				document.forms[0].action="<%=request.getContextPath()%>/FeesSMS.cp?action=getFeesSMS";
				document.forms[0].submit();
			}
		...
		<tr>
			<td class="padding">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td width="100%">
							<html:form action="FeesSMS" method="post">
								<table width="100%" border="0" align="center" cellpadding="0"
									...
									<tr class="toggle-section0">
										<td>
											<bean:define id="pageSizeList" name="feesSMSForm"
												property="pageSizeList" toScope="page" />
											<logic:empty property="studentFeeDetails" name="feesSMSForm">
												<bean:message key="no.search.projects" />
											</logic:empty>
											<logic:notEmpty property="studentFeeDetails"
												name="feesSMSForm">
												<tr>
																...
																<td>
																	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="padding-btm-ten form-border display-table-header">
																		<tr>
																			...
																			<th class="grid-heading-row">Paid Amt</th>
																			<th class="grid-heading-row">Actual Amt</th>
																			<th class="grid-heading-row">Check</th>																												
																		</tr>
								
																		<logic:iterate id="studentFeeDetails" name="feesSMSForm" property="studentFeeDetails" indexId="i" type="com.cubepro.student.StudentDetails">
																		<tr>
																		<td class="grid-row" align="left" >
																			<bean:write name="studentFeeDetails" property="admissionNo" />
																			<html:hidden name="studentFeeDetails" property="studentId" indexed="true" />
																		</td>
																		<td class="grid-row" align="right" >
																			<bean:write name="studentFeeDetails" property="studentName"  />
																		</td>
																		<td class="grid-row">
																			<bean:write name="studentFeeDetails" property="classDetails.classWithSectionName"  />
																		</td>
																		<td class="grid-row">
																			<bean:write name="studentFeeDetails" property="mobile"  />
																		</td>
																		<td class="grid-row">
																			<bean:write name="studentFeeDetails" property="paidAmt"  />
																		</td>
																		<td class="grid-row">
																			<bean:write name="studentFeeDetails" property="actualAmt"  />
																		</td>
																		<td class="grid-row">
															...
															<ul>
																...
																<li class="buttonrightcrnr submit"
																	...
																	<a href="javascript:submitAttendanceForm();"
																		onkeypress="if(event.keyCode == 32) {submitAttendanceForm();}">Send Fees SMS </a>
																</li>
																<li class="buttonrightcrnr reset"
																	onmouseover="this.className='buttonhighlight reset'"
																	onmouseout="this.className='buttonrightcrnr reset'"

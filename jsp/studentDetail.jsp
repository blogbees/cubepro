	...
	$(function(){
	   ...
	   function SubmitOnEnter(e) {
			...
			function submitSearch(){
					document.forms[0].action="<%=request.getContextPath()%>/ListOfStudents.cp?action=getListOfStudents";
		...
		<tr>
			<td class="padding">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td width="100%">
							<html:form action="ListOfStudents" method="post">
															...
															<tr class="toggle-section1">
																<td>
																	<display:table id="studentListTableId" 
																		name="searchResult" 
																		requestURI="ListOfStudents.cp?action=getListOfStudents"

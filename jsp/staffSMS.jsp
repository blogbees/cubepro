	...
	mmLoadMenus();	
	   function SubmitOnEnter(e) {
			...
			function submitSearch(){
				document.forms[0].action="<%=request.getContextPath()%>/StaffSMS.cp?action=getListOfStaffs";
				document.forms[0].submit();
			}
			
			function submitAttendanceForm(){
				document.forms[0].action="<%=request.getContextPath()%>/StaffSMS.cp?action=smsGeneral";
				document.forms[0].submit();
			}
			...
			function resetFilters(){
				...
				document.forms[0]['searchStaffDetails.dept'].value = "";
			}
								...
								<table width="100%" border="0" align="center" cellpadding="0"
											...
											<table width="100%" border="0" cellspacing="1"
												...
												<tr>
													<td colspan="10" class="form-heading">
														<span class="search-heading">Search Staff</span>
													</td>
												</tr>
												<tr>
									...
									<tr class="toggle-section0">
										<td>
											...
											<logic:empty property="staffList" name="generalSMSForm">
														...
														<table width="100%" border="0" cellspacing="1"
															...
															<tr class="toggle-section1">
																<td>
																		...
																		name="searchResult" 
																		requestURI="StaffSMS.cp?action=getListOfStaffs"
																		pagesize="10000" sort="list" defaultsort="1"
																		defaultorder="descending" excludedParams="action"
																		class="padding-btm-ten form-border display-table-header">
																		<display:column 
																			titleKey="staffDetails.staffId" 
																			paramId="staffId" paramProperty="staffId"
																			href="StaffDetail.cp?action=getStaff&"
																			property="staffId" style="width: 13%"
																		...
																		<display:column 
																			...
																			sortable="true" headerClass="grid-heading-row">
																			 <input type="checkbox" name="selectStaffForSMS" value="<%=i %>" />
																			</display:column>
																			<% i++; %>
																	</display:table>
																	</td></tr><tr><td>
														...
														<div id="button">
															<ul>
																...
																<li class="buttonrightcrnr submit"
																	...
																	title='<bean:message key = "general.sendGenralSMS"/>'>

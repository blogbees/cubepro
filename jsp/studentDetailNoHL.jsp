...
<script type="text/javascript"
	...
	$(function(){
	   ...
	   function SubmitOnEnter(e) {
			...
			function validate(){
				var dob = document.forms[0]['searchStudentDetails.dobString'];
			...
			function submitSearch(){
				if(validate()){
						document.forms[0].action="<%=request.getContextPath()%>/ListOfStudentsNoHL.cp?action=getListOfStudents";
		...
		<tr>
			<td class="padding">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td width="100%">
							<html:form action="ListOfStudentsNoHL" method="post">
															...
															<tr class="toggle-section1">
																<td>
																	<display:table id="studentListTableId" 
																		name="searchResult" 
																		requestURI="ListOfStudentsNoHL.cp?action=getListOfStudents"
																		...
																		<display:column 
																			titleKey="beneficiaryregisteration.firstname" 
																			property="rollNo" style="width: 13%"
																			sortable="true" headerClass="grid-heading-row"></display:column>																			
																		<display:column

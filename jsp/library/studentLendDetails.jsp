	...
	mmLoadMenus();	
	   function SubmitOnEnter(e) {
			...
			function submitSearch(){
				document.forms[0].action="<%=request.getContextPath()%>/StudentLendDetails.cp?action=getListOfStudents";
		...
		<tr>
			<td class="padding">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td width="100%">
							<html:form action="StudentLendDetails" method="post">
															...
															<tr class="toggle-section1">
																<td>
																	<display:table id="studentListTableId" 
																		name="searchResult" 
																		requestURI="StudentLendDetails.cp?action=getListOfStudents"
																		...
																		<display:column 
																			...
																			href="StudentTrack.cp?action=getStudentLendDetails&"

	...
	mmLoadMenus();	
	   function SubmitOnEnter(e) {
			...
			function submitSearch(){
				 if(validate()){
					document.forms[0].action="<%=request.getContextPath()%>/StaffLendDetails.cp?action=getListOfStaffs";
		...
		<tr>
			<td class="padding">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td width="100%">
							<html:form action="StaffLendDetails" method="post">
																...
																<td>
																	<display:table id="staffListTableId" 
																		...
																		<display:column 
																			...
																			href="StaffTrack.cp?action=getStaffLendDetails&"
